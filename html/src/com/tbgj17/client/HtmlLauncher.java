...
public class HtmlLauncher extends GwtApplication {
    ...
    void scaleCanvas() {
        ...
        float viewRatio = Main.WIDTH / (float) Main.HEIGHT;
    ...
    native void setupResizeHook() /*-{
        var htmlLauncher_onWindowResize = $entry(@com.tbgj17.client.HtmlLauncher::handleResize());
